export const Banner = () => {
    return (
        <div className="relative bg-white rounded-xl ml-10 mr-20 shadow-lg overflow-hidden flex flex-col md:flex-row items-center p-6 animate-fade-in-up transition-all duration-700">
            {/* Popping Icon */}
