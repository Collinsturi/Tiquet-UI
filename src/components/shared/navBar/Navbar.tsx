...
export const Navbar = () => {
    ...
    return (
        <>
            {/* Navbar */}
            <nav className="navbar bg-base-100 shadow-sm fixed w-full z-20">
                ...
                <div className="flex flex-1 items-center">
                    ...
                    <NavLink to={"/"} className="btn btn-ghost text-xl">Tkti</NavLink>
                </div>
                ...
                <div className="hidden lg:flex">
                    <ul className="flex flex-row gap-8 items-center">
                        ...
                        <li>
                            <a className="border-2 p-2 rounded-md" href="/login">Login</a>
                        </li>
                    </ul>
                </div>
            </nav>
