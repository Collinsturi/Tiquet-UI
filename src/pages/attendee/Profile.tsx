...
// --- React Icons Imports ---
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaEdit, FaSave, FaTimes, FaCreditCard, FaPaypal, FaPlus, FaTrash, FaCheckCircle, FaRegCircle, FaShoppingCart } from 'react-icons/fa';
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            <h1 className="text-3xl font-bold mb-6 flex items-center gap-2">
                <FaUser className="text-4xl" /> My Profile
            </h1>
                        ...
                        {!isEditing ? (
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    ...
                                    <FaSave className="w-5 h-5" /> Save Changes
                                </button>
                            </div>
                        )}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="form-control">
                        ...
                        <label className="input-group">
                            <span className="bg-base-200"><FaUser className="w-5 h-5" /></span>
                            <input
                                type="text"
                                name="name"
                                value={formData.name || ''}
                    ...
                    <div className="form-control">
                        ...
                        <label className="input-group">
                            <span className="bg-base-200"><FaEnvelope className="w-5 h-5" /></span>
                            <input
                                type="email"
                                name="email"
                    ...
                    <div className="form-control">
                        ...
                        <label className="input-group">
                            <span className="bg-base-200"><FaPhone className="w-5 h-5" /></span>
                            <input
                                type="tel"
                                name="phone"
                    ...
                    <div className="form-control">
                        ...
                        <label className="input-group">
                            <span className="bg-base-200"><FaMapMarkerAlt className="w-5 h-5" /></span>
                            <input
                                type="text"
                                name="address"
            ...
            <div className="card bg-base-100 shadow-xl p-6 max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-semibold flex items-center gap-2">
                        <FaCreditCard className="text-3xl" /> Payment Methods
                    </h2>
                    <button
                        className="btn btn-primary"
                    ...
                    >
                        <FaPlus className="w-5 h-5" /> Add New
                    </button>
                </div>
                        ...
                        {userProfile.paymentMethods.map(method => (
                            <div key={method.id} className="card card-bordered bg-base-200 shadow-sm p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    {method.type === 'card' ? (
                                        <FaCreditCard className="text-4xl text-base-content/70" />
                                    ) : (
                                        <FaPaypal className="text-4xl text-base-content/70" />
                                    )}
                                    <div>
                                ...
                                <div className="flex items-center gap-2">
                                    {!method.isDefault && (
                                        ...
                                        >
                                            ...
                                            <FaCheckCircle className="w-4 h-4" /> Set Default
                                        </button>
                                    )}
                                    <button
            ...
            <dialog id="add_payment_modal" className="modal" ref={addPaymentModalRef}>
                <div className="modal-box">
                    <h3 className="font-bold text-lg flex items-center gap-2">
                        <FaPlus className="w-6 h-6" /> Add New Payment Method
                    </h3>
