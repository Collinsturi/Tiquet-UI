        ...
        <Box sx={{ flexGrow: 1, p: 3 }}>
            ...
            <Grid container spacing={3} mb={4}>
                <Grid xs={12} sm={6} md={4}>
                    <Card variant="outlined" sx={{ p: 2, display: 'flex', alignItems: 'center', height: '100%' }}>
                ...
                <Grid xs={12} sm={6} md={4}>
                    <Card variant="outlined" sx={{ p: 2, display: 'flex', alignItems: 'center', height: '100%' }}>
                        ...
                        <Box>
                            ...
                            <Typography variant="h4" color="success.main">{upcomingTickets.length}</Typography>
                        </Box>
                    </Card>
                </Grid>
                ...
                <Grid xs={12} sm={6} md={4}>
                    <Card variant="outlined" sx={{ p: 2, display: 'flex', alignItems: 'center', height: '100%' }}>
                        ...
                        <Box>
                            ...
                            <Typography variant="h4" color="info.main">{pastTickets.length}</Typography>
                        </Box>
                    </Card>
                </Grid>
            </Grid>
