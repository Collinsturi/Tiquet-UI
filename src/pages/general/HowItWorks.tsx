        ...
        <div className="min-h-screen flex flex-col bg-base-200 font-sans">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 md:px-8 lg:px-12">
                ...
                <div className="space-y-16 max-w-5xl mx-auto">
                    ...
                    <section>
                        <h2 className="text-3xl md:text-4xl font-bold text-secondary text-center mb-8">For Attendees</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {/* Step 1: Discover Events */}
                            <div className="card bg-base-100 shadow-xl border border-base-300 rounded-lg transform transition-transform duration-300 hover:scale-[1.02]">
                                <div className="card-body items-center text-center p-6">
                                    ...
                                    <h3 className="card-title text-2xl font-semibold mb-2 text-primary">1. Discover Events</h3>
                            ...
                            <div className="card bg-base-100 shadow-xl border border-base-300 rounded-lg transform transition-transform duration-300 hover:scale-[1.02]">
                                <div className="card-body items-center text-center p-6">
                                    ...
                                    <h3 className="card-title text-2xl font-semibold mb-2 text-primary">2. Select & Secure</h3>
                                    <p className="text-base-content text-justify">
                            ...
                            <div className="card bg-base-100 shadow-xl border border-base-300 rounded-lg transform transition-transform duration-300 hover:scale-[1.02]">
                                <div className="card-body items-center text-center p-6">
                                    ...
                                    <h3 className="card-title text-2xl font-semibold mb-2 text-primary">3. Enjoy the Event!</h3>
                                    <p className="text-base-content text-justify">
                    ...
                    <section>
                        <h2 className="text-3xl md:text-4xl font-bold text-secondary text-center mb-8">For Organizers</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div className="card bg-base-100 shadow-xl border border-base-300 rounded-lg transform transition-transform duration-300 hover:scale-[1.02]">
                                <div className="card-body items-center text-center p-6">
                                    ...
                                    <h3 className="card-title text-2xl font-semibold mb-2 text-primary">1. Create Your Event</h3>
                                    <p className="text-base-content text-justify">
                            ...
                            <div className="card bg-base-100 shadow-xl border border-base-300 rounded-lg transform transition-transform duration-300 hover:scale-[1.02]">
                                <div className="card-body items-center text-center p-6">
                                    ...
                                    <h3 className="card-title text-2xl font-semibold mb-2 text-primary">2. Manage & Promote</h3>
                                    <p className="text-base-content text-justify">
                            ...
                            <div className="card bg-base-100 shadow-xl border border-base-300 rounded-lg transform transition-transform duration-300 hover:scale-[1.02]">
                                <div className="card-body items-center text-center p-6">
                                    ...
                                    <h3 className="card-title text-2xl font-semibold mb-2 text-primary">3. Insights & Payout</h3>
                                    <p className="text-base-content text-justify">
                    ...
                    <div className="alert alert-info shadow-lg mt-12 text-center max-w-4xl mx-auto">
                        <div>
                            ...
                            <a href="#" className="btn btn-sm btn-info-content ml-4 rounded-md">Sign Up Now</a>
                        </div>
                    </div>
                </div>
            </main>
