...
export const AdminLayout = () => {
    ...
    const sections = [
        ...
        { text: 'Schedule Communication', icon: <BarChartIcon />, path: '/admin/ScheduleCommunication' },
        { text: 'Communication templates', icon: <BarChartIcon />, path: '/admin/CommunicationTemplates' },
        { kind: 'divider' },
