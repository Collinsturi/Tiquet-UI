...
//     const [profileMessage, setProfileMessage] = useState<{ type: 'success' | 'error' | null; text: string }>({ type: null, text: '' });
//
...
//         }
//         setProfileMessage({ type: null, text: '' }); // Clear messages
//     };
//
...
//         setProfileMessage({ type: null, text: '' }); // Clear message before simulating
